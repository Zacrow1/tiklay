...
export default function TeacherPaymentsPage() {
  ...
  const calculatePayment = (data: PaymentCalculationValues) => {
    ...
    const spaceShare = totalIncome * (teacher.spacePercentage / 100)
    const medicalServiceTotal = studentCount * mockSystemConfig.medicalServiceFee
    const teacherShare = totalIncome - spaceShare - medicalServiceTotal
    ...
    const result = {
      ...
      medicalServiceTotal,
      teacherShare,
      spacePercentage: teacher.spacePercentage,
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between text-blue-600">
                        <span className="flex items-center">
                          ...
                          Porcentaje Espacio ({calculationResult.spacePercentage}%):
                        </span>
                      ...
                      <div className="border-t pt-2 flex justify-between text-lg font-bold text-green-600">
                        <span>Monto para el Profesor:</span>
                        <span>${calculationResult.teacherShare.toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                    <p className="text-sm text-yellow-800">
                      <strong>Importante:</strong> El profesor debe transferir ${calculationResult.spaceShare.toLocaleString()} 
                      (porcentaje del espacio) + ${calculationResult.medicalServiceTotal.toLocaleString()} 
                      (servicio médico) = ${(calculationResult.spaceShare + calculationResult.medicalServiceTotal).toLocaleString()}
                    </p>
                  </div>
